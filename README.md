...
### ✨ [**View the Live Demo Here!**](https://map-aitd.netlify.app/)
...
| Main Interface | Route Calculation |
| :---: | :---: |
| The clean, responsive interface with smart, auto-completing search fields. | Instantly calculates and displays the shortest path, ETA, and turn-by-turn directions. |
| ![Main Interface](assets/Screenshot%202025-09-17%20144129.jpg) | ![Calculated Route](assets/Screenshot%202025-09-17%20144201.jpg) |
...
* **▶️ Live Navigation Arrow**: A dynamic arrow simulates your movement along the path, pointing you toward your next turn.
...
1.  **Clone the Repository**
    ```bash
    git clone [https://github.com/Sachin-r-star/mapAITD.git](https://github.com/YourUsername/mapAITD.git) 
    # (https://github.com/Sachin-R-star/Map-AITD-.git)
    ```
...
3.  **Run with a Live Server**
    ...
    * Right-click on the `public/index.html` file and select **"Open with Live Server"**.
